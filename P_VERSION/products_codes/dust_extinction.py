...
class DustModelGrid(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.flux_clean = kwargs['flux']
        self.wavelength = kwargs['wavelength']/1e4
        ext_law_name = kwargs['ext_law_name']        
        dust_dimension = kwargs['dust_dimension']
    ...
    def extinction_grid_builder(self, n_models, name):
        ...
        self.RV = 3.1
        self.A_V = np.logspace(-1.5, 0.5, n_models)
        self.colorexcess_B_V = self.A_V/self.RV        
        ...
        if name=='cardelli89':
            ...
            A_lambda = self.ext_law(_lambda=self.wavelength, RV=self.RV)
...
class extinction_laws:
    ...
    def Cardelli89_ext_law(_lambda, RV):
    ...
    def Calzetti2000_ext_law(_lambda, RV):
