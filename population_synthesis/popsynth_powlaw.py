...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb  7 19:07:50 2020
...
for IMF_i in IMF:
  ...
  for i, beta_i in enumerate(beta): 
      ...
      CEM = SPiCE_CEM.Powlaw(M_inf=M_inf, beta=beta_i, t_0=t_0,
                                        R=returned_gas_frac, z_sn=z_sn,  w=w)
          
      filename = IMF_i + '_beta_'+format(beta_i, '08.4f')
...
df.to_csv(globparams_folder+'params_t_{:5.2}.csv'.format(galaxy.today/units.Gyr))
